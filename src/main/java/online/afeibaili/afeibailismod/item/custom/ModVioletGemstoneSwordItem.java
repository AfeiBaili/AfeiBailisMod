...
public class ModVioletGemstoneSwordItem extends SwordItem {
    public ModVioletGemstoneSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
