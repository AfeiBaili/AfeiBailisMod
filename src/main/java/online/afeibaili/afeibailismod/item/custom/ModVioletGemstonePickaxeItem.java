...
public class ModVioletGemstonePickaxeItem extends PickaxeItem {
    public ModVioletGemstonePickaxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
