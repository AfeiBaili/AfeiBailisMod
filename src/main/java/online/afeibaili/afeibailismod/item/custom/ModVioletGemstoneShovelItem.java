...
public class ModVioletGemstoneShovelItem extends ShovelItem {
    public ModVioletGemstoneShovelItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings) {
